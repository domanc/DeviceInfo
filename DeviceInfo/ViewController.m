...
//    DeviceInfo *infoModel = [DeviceInfo infoWithDict:infoDict];
//    
//    cell.textLabel.text = infoModel.infoKey;
//    cell.detailTextLabel.text = [NSString stringWithFormat:@"------>%@", infoModel.infoValue];
//    
    cell.textLabel.text = infoDict[@"infoKey"];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"------>%@", infoDict[@"infoValue"]];
